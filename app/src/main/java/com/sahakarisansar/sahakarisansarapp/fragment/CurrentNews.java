...
public class CurrentNews extends Fragment {
    View myView;
    WebView mwebview;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.tab1news, container, false);

        mwebview = (WebView) myView.findViewById(R.id.mwebview);

        WebSettings webSetting = mwebview.getSettings();
        mwebview.getSettings().setJavaScriptEnabled(true);
        mwebview.loadUrl("http://www.sahakarisansar.com/mobileapp/local-news");
